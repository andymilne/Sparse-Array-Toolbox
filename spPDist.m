...
%   entries. When there are only two arguments, p is taken to be 2, which gives
%   the Euclidean distance between the two vectors; when p = 1, this function
%   gives the taxicab distance; when p = inf, it gives the maximum difference.
%
